...
Demo
----------------
[JQuery lightSlider demo](//sachinchoolur.github.io/lightslider/)
...
You can Install lightslider using the [Bower](//bower.io) package manager.
...
You can also find lightslider on [npm](//npmjs.org).
