  ...
  function add($state){
    ...
    switch ($state){
      ...
      case SAVE_STATE:
       ...
       $res="<html><body><h3>Форма для заказа каталога мебели</h3><br>";
       ...
       form_to_db("заказ каталога",$res);

       mail_msg_html(get_proper("ordcat_mail_to"),"Новая заявка на каталог с www.orgspace.ru",$res);
