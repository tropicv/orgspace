  ...
  function add($state){
    ...
    switch ($state){
      ...
      case SAVE_STATE:
       ...
       $res="<html><body><h3>Форма для заказа каталога giroflex (кресла)</h3><br>";
       ...
       form_to_db("заказ каталога giroflex",$res);

       mail_msg_html(get_proper("ordgiro_mail_to"),"Новая заявка на каталог giroflex с www.orgspace.ru",$res);
