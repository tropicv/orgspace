  ...
  function add($state){
    ...
    switch ($state){
      ...
      case SAVE_STATE:
       ...
       $res="<html><body><h3>Форма для заявки на звонок</h3><br>";
       $res.="<b>* Имя</b>: " .$f->getf("name")."<br>";
       $res.="<b>Компания</b>: " .$f->getf("company")."<br>";
       $res.="<b>Телефон</b>: " .$f->getf("tel")."<br>";
       $res.="<b>Время звонка</b>: " .$f->getf("time")."<br>";
       $res.="<br><hr><br>Orgspace.ru</body></html>";

       form_to_db("заявка на звонок",$res);

       mail_msg_html(get_proper("callback_mail_to"),"Новая заявка на звонок с www.orgspace.ru",$res);
