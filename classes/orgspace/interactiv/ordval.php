  ...
  function add($state){
    ...
    switch ($state){
      ...
      case SAVE_STATE:
       ...
       $res="<html><body><h3>Форма для заказа каталога Valencia</h3><br>";
       ...
       form_to_db("заказ каталога Valencia",$res);

       mail_msg_html(get_proper("ordval_mail_to"),"Новая заявка на каталог Valencia с www.orgspace.ru",$res);
