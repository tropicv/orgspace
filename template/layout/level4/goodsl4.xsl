...
<!-- TEST CHAIRS -->
 <xsl:if test="../@rurl!='chairs-order' and ../@rurl='chairs-example'">
	...
	<tr>
		<td><img src="/images/dot.gif" width="1" height="1" border="0"/><br/></td>
		<td class="wtext">
			<div style="margin: 5px 0;"><a href="chairs-order?walias={../@walias}&amp;obj={../@obj}" style="padding: 5px 0;">Заказать</a></div>
		</td>
	</tr>
	<tr>
		<td colspan="2">
...
<xsl:if test="../@rurl='gtype-view' and ../@obj='46'">
	...
	<tr>
		<td><img src="/images/dot.gif" width="1" height="1" border="0"/><br/></td>
		<td class="wtext">
			<div style="margin: 5px 0;"><a href="gtype-order?predmet={../@predmet}&amp;obj={../@obj}" style="padding: 5px 0;">Узнать больше</a></div>
		</td>
	</tr>
	<tr>
		<td colspan="2">
