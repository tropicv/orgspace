...
<xsl:template match="container_view_dbuyl4_edit"> 
...
<xsl:template match="container_view_dbuyl4"> 
...
<table border="0" cellspacing="0" cellpadding="0" class="buy">
<tr>
<td class="wnav">
