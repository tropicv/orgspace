...
<xsl:if test="$admin=1">
<br/><div class="design_action">[<a href="design-del?obj={@id}">Удалить зону</a>]</div>
<br/>
</xsl:if>
...
<xsl:if test="$admin=1">
[<a href="design-add">Добавить</a>]<br/>
[<a href="container-managewrapper?i=design&amp;m=all&amp;creator=container.view.empty" target="blank">Редактировать шаблон</a>]
</xsl:if>
