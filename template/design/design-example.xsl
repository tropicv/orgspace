...
<xsl:template match="design_example"> 
...
[<a href="container-managewrapper?i=design&amp;m=example&amp;walias={design_db/@walias}&amp;creator=container.view.goodsl4" target="blank">Редактировать шаблон</a>]
</xsl:if>


</xsl:template>

<xsl:template match="design_example" mode="title"> 
<a class="white" href="design-view?walias={design_db/@walias}"><xsl:value-of select="design_db/@short_name"/></a>
</xsl:template>

<xsl:template match="design_example" mode="path"> 
...
<xsl:value-of select="$lc/design/example"/>
</div>

</xsl:template>

<xsl:template match="design_example" mode="left_start"> 
...
<xsl:template match="design_example" mode="left_end"> 
</xsl:template>

<xsl:template match="design_example" mode="content_title"> 
<xsl:value-of select="design_db/@name"/>
</xsl:template>

<xsl:template match="design_example" mode="content_start"> 
</xsl:template>

<xsl:template match="design_example" mode="content_end"> 
</xsl:template>

<xsl:template match="design_example" mode="right_start"> 
...
<xsl:template match="design_example" mode="right_end"> 
</xsl:template>

<xsl:template match="design_example" mode="under_start"> 
</xsl:template>

<xsl:template match="design_example" mode="under_end"> 
</xsl:template>
