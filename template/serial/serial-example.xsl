...
<xsl:template match="serial_example"> 
...
[<a href="container-managewrapper?i=serial&amp;m=example&amp;walias={serial_db/@walias}&amp;creator=container.view.goodsl4" target="blank">Редактировать шаблон</a>]
</xsl:if>


</xsl:template>

<xsl:template match="serial_example" mode="title"> 
<a class="white" href="serial-view?walias={serial_db/@walias}"><xsl:value-of select="serial_db/@short_name"/></a>
</xsl:template>

<xsl:template match="serial_example" mode="path"> 
...
<xsl:value-of select="$lc/serial/example"/>
</div>

</xsl:template>

<xsl:template match="serial_example" mode="left_start"> 
...
<xsl:template match="serial_example" mode="left_end"> 
</xsl:template>

<xsl:template match="serial_example" mode="content_title"> 
 <xsl:value-of select="serial_db/@name"/>
</xsl:template>

<xsl:template match="serial_example" mode="content_start"> 
</xsl:template>

<xsl:template match="serial_example" mode="content_end"> 
</xsl:template>

<xsl:template match="serial_example" mode="right_start"> 
...
<xsl:template match="serial_example" mode="right_end"> 
</xsl:template>

<xsl:template match="serial_example" mode="under_start"> 
</xsl:template>

<xsl:template match="serial_example" mode="under_end"> 
</xsl:template>
