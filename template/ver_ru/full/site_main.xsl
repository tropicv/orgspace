...
<xsl:include href="user_menu.xsl"/>
...
<meta name="yandex-verification" content="660a7fff4991da11" />
...
<link rel="stylesheet" type="text/css" href="/scp/main7.css"/>
...
<!-- === START LIGHTSLIDER === -->
<!--
<script src="/scp/lightslider/js/lightslider.js"></script>
<link rel="stylesheet" type="text/css" href="/scp/lightslider/css/lightslider.css" />
-->
<script src="//ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.min.js"></script>

<!-- === END LIGHTSLIDER === -->

<script type="text/javascript" src="/scp/highslide.js"></script>
<link rel="stylesheet" type="text/css" href="/scp/highslide.css" />

<!--<xsl:choose> 
 <xsl:when test="($content/*/@item='gtype' and $content/*/@meth='view') or (($content/*/@item='zone' or $content/*/@item='serial') and $content/*/@meth='example') or ($content/*/@item='serial' and ($content/*/@meth='elements' or $content/*/@meth='accessories')) or ($content/*/@item='container' and $content/*/@meth='view')">
-->
<script type="text/javascript">
hs.graphicsDir = '/scp/graphics/';
hs.align = 'center';
...
ga('create', 'UA-44527356-1', 'orgspace.ru');
ga('send', 'pageview');
...
<xsl:choose>
 <xsl:when test="$lc/@lang!='en'"><a href="//www.orgspace-consulting.com">english</a></xsl:when>
 <xsl:otherwise><a href="//www.orgspace.ru">русский</a></xsl:otherwise>
</xsl:choose>
...
<noscript><div><img src="https://mc.yandex.ru/watch/1489401" style="position:absolute; left:-9999px;" alt="" /></div></noscript>
<!-- /Yandex.Metrika counter -->
]]></xsl:text>
...
My="";My+="<img src='//"+Mu+"/cnt?cid=622997&"+Mz+"&sl="+Msl+"&r="+escape(Md.referrer)+"&fr="+Mfr+"&pg="+escape(window.location.href);
My+="' border=0  width=1 height=1  alt='SpyLOG'>";
Md.write(My);//--></script><noscript>
<img src="//u6229.97.spylog.com/cnt?cid=622997&p=0" alt='SpyLOG' border='0'  width=1 height=1 >
</noscript>
<!-- SpyLOG  -->
]]></xsl:text>
 </xsl:when> 
...
My+="<img src='//"+Mu+"/cnt?cid=622997&"+Mz+"&sl="+Msl+"&r="+escape(Md.referrer)+"&pg="+escape(window.location.href)+"' border=0  width=1 height=1  alt='SpyLOG'>";
Md.write(My);//--></script><noscript>
<img src="//u6229.97.spylog.com/cnt?cid=622997&p=1" alt='SpyLOG' border='0'  width=1 height=1 >
</noscript>
<!-- SpyLOG  -->
]]></xsl:text>
 </xsl:when> 
...
<xsl:text disable-output-escaping="yes"><![CDATA[
<!--begin of Top100--> 
<a href="//top100.rambler.ru/top100/"><img src="//counter.rambler.ru/top100.cnt?683505" alt="Rambler's Top100" width=1 height=1 border=0></a>
<!--end of Top100 code--> 
...
<xsl:when test="not($content/container_pview/child::*) and not($content/manager_pall/child::*) and not($content/feedback_padd/child::*) and not($content/*/@mod='print') and ($content/container_view/container_db/@nomenu!=1 or $wrapper/container_db/@nomenu!=1 or (not($content/container_view) and not($wrapper/container_db)))">
...
<xsl:if test="user_menu/@meth='view' or (user_menu/@meth='add' and user_menu/@item!='news')">
    <xsl:choose>
	<xsl:when test="user_menu/@creator!=''"></xsl:when>
	<xsl:otherwise>
	    <xsl:call-template name="politic_coockie"/>
	</xsl:otherwise>
    </xsl:choose>
</xsl:if>
...
<script language="javascript"><!--
Mrn=Math.random();Mz="";
My="<a href='//u6229.97.spylog.com/cnt?cid=622997&f=3&rn="+Mrn+"' target='_blank'><img src='//u6229.97.spylog.com/cnt?cid=622997&";
My+="p=1&f=4&rn="+Mrn+Mz+"' border=0  width=1 height=1   alt='SpyLOG'></a>";Md.write(My); 
//--></script><noscript>
<a href="//u6229.97.spylog.com/cnt?cid=622997&f=3&p=1" target="_blank">
<img src="//u6229.97.spylog.com/cnt?cid=622997&p=1&f=4" alt='SpyLOG' border='0'  width=1 height=1 ></a> 
</noscript>
]]></xsl:text>
...
<xsl:text disable-output-escaping="yes"><![CDATA[
<!--PerfectSeo counter--><script type="text/javascript"><!--
document.write("<a href='//perfectseo.ru' "+
"target=_blank><img src='//enter.perfectseo.ru/counter/core.php?client_id=CnJFSk8Usp&img_id=7&referer="+ escape(document.referrer)+"&target="+escape(document.URL)+
"&rand="+Math.random()+
"' alt='' title='ПерфектСео: количество посетителей с поисковых систем за этот день'"+
"border=0 width=1 height=1></a>")//--></script><!--/PerfectSeo-->
]]></xsl:text>
...
<xsl:when test="name($func)='chairs_all'">
<xsl:value-of select="$lc/chairs/@name"/>
</xsl:when>
<xsl:when test="name($func)='chairs_view'">
<!--<xsl:value-of select="$lc/chairs/@name"/> - <xsl:value-of select="$func/chairs_db/@name"/>-->
<xsl:value-of select="$func/chairs_db/@name"/>
</xsl:when>
<xsl:when test="name($func)='chairs_example'">
<!-- <xsl:value-of select="$lc/chairs/@name"/> - <xsl:value-of select="$func/chairs_db/@name"/> - <xsl:value-of select="$func/chairsitem_db/@name"/>-->
<xsl:value-of select="$func/chairs_db/@name"/> - <xsl:value-of select="$func/chairsitem_db/@name"/>
</xsl:when>
