...
[<a href="container-managewrapper?i=subscr&amp;m=add&amp;state={@last_state}&amp;creator=container.view.dorgl4" target="blank">Редактировать шаблон</a>]
</xsl:when>
<xsl:otherwise>
[<a href="container-managewrapper?i=subscr&amp;m=add&amp;creator=container.view.dorgl4" target="blank">Редактировать шаблон</a>]
</xsl:otherwise>
</xsl:choose>
</xsl:if>
...
<tr>
<td colspan="2">Подписаться на</td>
</tr>

<tr>
<td colspan="2"><input type="checkbox" name="snews"/>Новости</td>
</tr>

<tr>
<td colspan="2"><input type="checkbox" name="sdig"/>Публикации</td>
</tr>
